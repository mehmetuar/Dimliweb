...
export const SHOTS = {
  ...
  macDegerlendirme: { src: "/3d/tex/mac_degerlendirme.webp", alt: "Dimli maç değerlendirme ekranı" },
  rakipDegerlendirme: { src: "/3d/tex/rakip_degerlendirme.webp", alt: "Dimli rakip değerlendirme ekranı" },
} as const;
