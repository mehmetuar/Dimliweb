// Gerçek mağaza URL'leri — tek kaynak (kopya rozet tanımları buradan import edilir).
export const APP_STORE_URL = "https://apps.apple.com/tr/app/dimli/id6764278538?l=tr";
export const GOOGLE_PLAY_URL =
  "https://play.google.com/store/apps/details?id=com.dimli.app&hl=tr";

const badgeClass =
  "flex items-center gap-3 justify-center px-5 py-3 rounded-2xl bg-pitch-surface/70 border border-white/10 text-white hover:border-white/25 hover:bg-pitch-surface transition-all active:scale-95";
...
export const GooglePlayBadge = ({ className = "" }: { className?: string }) => (
  <a
    ...
    aria-label="Dimli'yi Google Play'den indir"
  ...
  >
    ...
    <div className="text-left">
      <div className="text-[10px] text-white/50 leading-none font-medium tracking-wide uppercase">İndir</div>
...
export const AppStoreBadge = ({ className = "" }: { className?: string }) => (
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    aria-label="Dimli'yi App Store'dan indir"
    className={`${badgeClass} ${className}`}
  >
