...
export default function PhoneCarousel() {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      {/* Floodlight sweep — stadyum projektörü dokusu (CSS-only, reduced-motion'da durur) */}
      <span className="floodlight-sweep absolute top-0 left-0 h-full w-1/3 z-10 pointer-events-none bg-gradient-to-r from-transparent via-turf-500/15 to-transparent blur-2xl" />
      ...
      >
        {doubled.map(({ src, label, desc }, i) => (
          <div key={i} className="flex flex-col items-center gap-3 flex-shrink-0">
            ...
            <Phone3D accent="turf" sheen={false} glow={false} enter={false} tiltMax={5}>
              <div
