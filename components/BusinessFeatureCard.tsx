...
import { Tilt3DCard } from "@/components/motion";
...
export default function BusinessFeatureCard({ icon, title, description }: BusinessFeatureCardProps) {
  return (
    <Tilt3DCard
      glow="ember"
      className="group h-full flex flex-col items-center text-center p-5 sm:p-6 rounded-2xl border border-slate-700/50 bg-pitch-surface/40 hover:border-ember-500/40 hover:bg-pitch-surface/70 transition-colors duration-300"
    >
